    ...
    void showFailureDialog() {
        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
            	...
            	errorDialog = makeSimpleDialog("The application is incorrectly configured. Check that the package name and signing certificate match the client ID created in Developer Console. " +
            			"Also, if the application is not yet published, check that the account you are trying to sign in with is listed as a tester account. See logs for more information");
...
//                printMisconfiguredDebugInfo();
                break;
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
            	errorDialog = makeSimpleDialog("Failed to sign in. Please check your network connection and try again");
            	printMisconfiguredDebugInfo();
//                errorDialog = makeSimpleDialog(ctx.getString(
//                        R.string.gamehelper_sign_in_failed));
                break;
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
            	errorDialog = makeSimpleDialog("License check failed");
            	printMisconfiguredDebugInfo();
//                errorDialog = makeSimpleDialog(ctx.getString(
